...
export const Sidebar = () => {
    ...
    const sidebarRef = useRef(null); // Tạo ref để tham chiếu tới Sidebar
        ...
        <div className=''>
            ...
            >
                <div className="h-full px-3 py-4 overflow-y-auto border border-t-0 bg-on-surface-1">
                    ...
                    <ul className="pt-4 mt-4 space-y-2 font-medium text-sm border-t border-gray-200">
                        ...
                        <li>
                            <Link to='/login' onClick={logoutUser} className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                                <svg className="w-6 h-6 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
